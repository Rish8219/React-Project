...
const Offers = () => {
    return (
        ...
        <div className="offers-left w-full md:w-1/2 text-center md:text-left">
            ...
            <button className='border-none text-xl font-bold max-[550px]:p-2 max-[450px]:text-sm bg-amber-500 rounded-2xl px-6 py-3 mt-8 cursor-pointer hover:bg-amber-600 transition duration-300'>
                Check Now
            </button>
        </div>
